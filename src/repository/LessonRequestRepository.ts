...
export class LessonRequestRepository {
    static async createLessonRequest(lessonRequest: LessonRequest): Promise<LessonRequest> {
        return await MysqlDataSource.getRepository(LessonRequest).save(lessonRequest);
    }
